function [Sigma,Alpsup,w0,pos,history,obj,status] = mklTrST(K,yapp,C,option,verbose)
...
while loop & nloopmax >0 ;
    ...
    %-----------------------------------------
    t = cputime ;
    [Sigma,Alpsup,w0,pos,obj] = mkltrSTupdate1(K,Sigma,pos,Alpsup,w0,C,yapp,grad,obj,option) ;
    %-----------------------------------------
    % Thresholding
    %-----------------------------------------
