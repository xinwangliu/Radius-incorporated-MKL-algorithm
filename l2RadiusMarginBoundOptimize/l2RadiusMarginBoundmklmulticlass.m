function [radius,Sigma,Alpsup,w0,pos,nbsv,SigmaH,obj] = l2RadiusMarginBoundmklmulticlass(K,yapp,nbclass,option,verbose)
...
switch option.algo
    case 'oneagainstall'
        [radius,optimalBeta,xsup,Alpsup,w0,nbsv,pos,obj] = l2RadiusMarginBoundmulticlassoneagainstall([],yapp,nbclass,lambdareg,K,Sigma,verbosesvm);
        [grad] = gradl2RadiusMarginBoundoneagainstall(K,Sigma,pos,Alpsup,nbsv,radius,optimalBeta);
    case 'oneagainstone'
...
while loop 
    ...
    %---------------------------------------------
    t = cputime ;
    [radius,optimalBeta,Sigma,Alpsup,w0,pos,nbsv,obj] = l2RadiusMarginBoundmulticlassupdate(K,Sigma,pos,Alpsup,w0,yapp,nbclass,nbsv,grad,obj,radius,optimalBeta,option);
