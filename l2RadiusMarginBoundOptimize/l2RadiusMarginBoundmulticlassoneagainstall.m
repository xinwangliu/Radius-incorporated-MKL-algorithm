function [radius,optimalBeta,xsup,w,b,nbsv,pos,obj] = l2RadiusMarginBoundmulticlassoneagainstall(x,y,nbclass,lambda,K,Sigma,verbose,warmstart)
...
for i=1:nbclass
    ...
    [radius, optimalBeta, xsupaux,waux,baux,posaux,alphaaux,marginaux,objaux]= radiusMarginBoundClass(x,yone,lambda,K,Sigma,verbose,alphainit);
