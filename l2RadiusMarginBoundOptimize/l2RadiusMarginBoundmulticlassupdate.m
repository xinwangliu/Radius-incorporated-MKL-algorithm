function [radius,optimalBeta,Sigma,Alpsup,w0,pos,nbsv,CostNew] = l2RadiusMarginBoundmulticlassupdate(K,Sigma,pos,Alpsup,w0,yapp,nbclass,nbsv,GradNew,CostNew,radiusNew,optimalBetaNew,option)
...
while costmax<costmin;
    ...
    [radiusaux,optimalBetaaux,costmax,Alpsupaux,w0aux,posaux,nbsvaux] = costl2RadiusMarginBoundoneagainstall(K,stepmax,desc,SigmaNew,Alpsup,yapp,pos,nbsv,nbclass,option);
...
while (stepmax-stepmin)>option.goldensearch_deltmax*(abs(deltmax));
    ...
    [radiusr,optimalBetar,costmedr,Alpsupr,w0r,posr,nbsvr] = costl2RadiusMarginBoundoneagainstall(K,stepmedr,desc,SigmaNew,Alpsup,yapp,pos,nbsv,nbclass,option) ;
    [radiusl,optimalBetal,costmedl,Alpsupl,w0l,posl,nbsvl] = costl2RadiusMarginBoundoneagainstall(K,stepmedl,desc,SigmaNew,Alpsup,yapp,pos,nbsv,nbclass,option) ;
