function [Sigma,Alpsup,w0,pos,CostNew] = l2optimalMarginClassUpdateCV(K,Sigma,pos,Alpsup,w0,C,yapp,GradNew,CostNew, option)
...
while costmax<costmin;
    ...
    [costmax, Alpsupaux,w0aux,posaux] = costl2optimalMarginClassCV(K,stepmax,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
...
while (stepmax-stepmin)>option.goldensearch_deltmax*(abs(deltmax))  & stepmax > eps;
    ...
    [costmedr,Alpsupr,w0r,posr] = costl2optimalMarginClassCV(K,stepmedr,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
    [costmedl,Alpsupl,w0l,posl] = costl2optimalMarginClassCV(K,stepmedl,desc,SigmaNew,posr,Alpsupr,C,yapp,option) ;
