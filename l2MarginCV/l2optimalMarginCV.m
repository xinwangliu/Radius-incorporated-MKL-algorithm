function [Sigma,Alpsup,w0,pos,history,obj,status] = l2optimalMarginCV(K,yapp,C,option,verbose)
%% Author: Xinwang Liu
% Inputs
%
...
[xsup,Alpsup,w0,pos,alpha,obj] = l2optimalMarginClassCV([],yapp,C,lambdareg, kernel, kerneloption,verbosesvm,alphainit);

%compute gradient
[grad] = l2optimalMarginGradCV(K,pos,Alpsup);
...
while loop & nloopmax >0 ;
    ...
    %-----------------------------------------
    t = cputime ;
    [Sigma,Alpsup,w0,pos,obj] = l2optimalMarginClassUpdateCV(K,Sigma,pos,Alpsup,w0,C,yapp,grad,obj, option);
