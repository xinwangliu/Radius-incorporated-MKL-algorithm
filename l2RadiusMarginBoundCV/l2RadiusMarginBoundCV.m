function [Sigma,Alpsup,w0,pos,history,obj,status] = l2RadiusMarginBoundCV(K,yapp,C,option,verbose)
%% Author: Xinwang Liu
% Inputs
%
...
[radius, optimalBeta, xsup,Alpsup,w0,pos,alpha,margin,obj] = l2MarginClassCV([],yapp,C,lambdareg, kernel, kerneloption,verbosesvm,alphainit);
%compute gradient
[grad] = l2RadiusMarginBoundGradCV(K,pos,Alpsup,margin,radius,optimalBeta);
...
while loop & nloopmax >0 ;
    ...
    %-----------------------------------------
    t = cputime ;
    [radius,optimalBeta, margin,Sigma,Alpsup,w0,pos,obj] = l2RadiusMarginBoundUpdateCV(K,Sigma,pos,Alpsup,w0,C,yapp,grad,obj,radius,optimalBeta, margin, option);
