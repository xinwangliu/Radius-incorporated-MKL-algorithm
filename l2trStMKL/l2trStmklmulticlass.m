function [Sigma,Alpsup,w0,pos,nbsv,SigmaH,obj] = l2trStmklmulticlass(K,yapp,option,verbose)
...
[xsup,Alpsup,w0,nbsv,pos,obj]=l2trStmulticlassoneagainstall([],yapp,nbclass,lambdareg,K,Sigma,verbosesvm);
[grad] = gradl2trStoneagainstall(K,pos,Alpsup,nbsv);
...
while loop ; 
    ...
    %---------------------------------------------
    t = cputime ;
    [Sigma,Alpsup,w0,pos,nbsv,obj] = l2trStmulticlassupdate(K,Sigma,pos,Alpsup,w0,yapp,nbclass,nbsv,grad,obj,option);
    %-----------------------------------------
    % Thresholding
    %-----------------------------------------
