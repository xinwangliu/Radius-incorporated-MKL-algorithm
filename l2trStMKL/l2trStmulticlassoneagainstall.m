function [xsup,w,b,nbsv,pos,obj]=l2trStmulticlassoneagainstall(x,y,nbclass,lambda,K,Sigma,verbose,warmstart)
...
for i=1:nbclass
    ...
    [xsupaux,waux,baux,posaux,alphaaux,objaux]=l2trStClass(x,yone,lambda,K,Sigma,verbose,alphainit);
