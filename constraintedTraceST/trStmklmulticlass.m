function [Sigma,Alpsup,w0,pos,nbsv,SigmaH,obj] = trStmklmulticlass(K,yapp,C,nbclass,option,verbose)
...
while loop ; 
    ...
    %---------------------------------------------
    t = cputime ;
    [Sigma,Alpsup,w0,pos,nbsv,obj] = trStmklmulticlassupdate(K,Sigma,pos,Alpsup,w0,C,yapp,nbclass,nbsv,grad,obj,option) ;
    %-----------------------------------------
    % Thresholding
    %-----------------------------------------
% 
