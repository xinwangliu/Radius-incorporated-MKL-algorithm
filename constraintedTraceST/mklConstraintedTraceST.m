function [Sigma,Alpsup,w0,pos,history,obj,status] = mklConstraintedTraceST(K,yapp,C,option,verbose)
...
[grad] = gradsvmclass(K,pos,Alpsup);
...
while loop & nloopmax >0 ;
    ...
    %-----------------------------------------
    t = cputime ;
    [Sigma,Alpsup,w0,pos,obj] = mklConstraintedTraceSTupdate(K,Sigma,pos,Alpsup,w0,C,yapp,grad,obj,option) ;
    %-----------------------------------------
    % Thresholding
    %-----------------------------------------
