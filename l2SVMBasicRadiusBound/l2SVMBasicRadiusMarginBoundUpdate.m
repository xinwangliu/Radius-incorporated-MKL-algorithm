function [radius,radiusp,Sigma,Alpsup,w0,pos,CostNew] = l2SVMBasicRadiusMarginBoundUpdate(K,Sigma,pos,Alpsup,w0,C,yapp,GradNew,CostNew,radiusNew,radiuspNew, option)
...
while costmax<costmin;
    ...
    [costmax,radiusaux, radiuspaux, Alpsupaux,w0aux,posaux] = costl2SVMBasicRadiusMarginBoundclass(K,stepmax,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
    if costmax<costmin
        costmin = costmax;
...
while (stepmax-stepmin)>option.goldensearch_deltmax*(abs(deltmax))  & stepmax > eps;
    ...
    [costmedr,radiusr, radiuspr,Alpsupr,w0r,posr] = costl2SVMBasicRadiusMarginBoundclass(K,stepmedr,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
    [costmedl,radiusl, radiuspl,Alpsupl,w0l,posl] = costl2SVMBasicRadiusMarginBoundclass(K,stepmedl,desc,SigmaNew,posr,Alpsupr,C,yapp,option) ;
