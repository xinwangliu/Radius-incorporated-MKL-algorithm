function [trST,trSTp,xsup,w,b,nbsv,pos,obj] =trStmulticlassoneagainstall(x,y,C,nbclass,lambda,K,Sigma,verbose,warmstart)
...
for i=1:nbclass
    ...
    [trST,trSTp,xsupaux,waux,baux,posaux,alphaaux,objaux]= traceSTclass(x,yone,C,lambda,K,Sigma,verbose,alphainit);
