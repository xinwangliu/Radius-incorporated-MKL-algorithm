function [trST,trSTp,Sigma,Alpsup,w0,pos,CostNew] = mklTraceSTupdate(K,Sigma,pos,Alpsup,w0,C,yapp,GradNew,CostNew,trSTNew,trSTpNew,option)
...
while costmax<costmin;
    ...
    [trSTaux,trSTpaux,costmax,Alpsupaux,w0aux,posaux] = costTraceSTclass(K,stepmax,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
...
while (stepmax-stepmin)>option.goldensearch_deltmax*(abs(deltmax))  & stepmax > eps;
    ...
    %[trST,trSTp,cost,Alpsupaux,w0aux,posaux] = costtrSTclass(K0,StepSigma,DirSigma,Sigma,indsup,Alpsup,C,yapp,option)
    [trSTr,trSTpr,costmedr,Alpsupr,w0r,posr] = costTraceSTclass(K,stepmedr,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
    [trSTl,trSTpl,costmedl,Alpsupl,w01,posl] = costTraceSTclass(K,stepmedl,desc,SigmaNew,posr,Alpsupr,C,yapp,option) ;
