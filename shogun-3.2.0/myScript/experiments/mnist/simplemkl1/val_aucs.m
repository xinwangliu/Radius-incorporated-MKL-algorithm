...
%
% Synopsis: 
%   [prc_auc,roc_auc,tp,fp,ppv] = val_PPV(s,Ytr)
%   [prc_auc,roc_auc,tp,fp,ppv] = val_PPV(s,Ytr,'property',value)
% 
% Arguments: 
%   s:   anomaly scores 
...
% 
% $Id: val_aucs.m,v 1.1 2007/02/01 14:27:38 neuro_cvs Exp $
% 
...
opt = set_defaults(opt, 'd',0, 'gra', 10);
