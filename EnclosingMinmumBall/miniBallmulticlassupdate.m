function [radius,optimalBeta,Sigma,Alpsup,w0,pos,nbsv,CostNew] = miniBallmulticlassupdate(K,Sigma,C,pos,Alpsup,w0,yapp,nbclass,nbsv,GradNew,CostNew,radiusNew,optimalBetaNew,option)
...
while costmax<costmin;
    ...
    [radiusaux,optimalBetaaux,costmax,Alpsupaux,w0aux,posaux,nbsvaux] = costMiniBallMKLoneagainstall(K,C,stepmax,desc,SigmaNew,Alpsup,yapp,pos,nbsv,nbclass,option);
...
while (stepmax-stepmin)>option.goldensearch_deltmax*(abs(deltmax));
    ...
    [radiusr,optimalBetar,costmedr,Alpsupr,w0r,posr,nbsvr] = costMiniBallMKLoneagainstall(K,C,stepmedr,desc,SigmaNew,Alpsup,yapp,pos,nbsv,nbclass,option) ;
    [radiusl,optimalBetal,costmedl,Alpsupl,w0l,posl,nbsvl] = costMiniBallMKLoneagainstall(K,C,stepmedl,desc,SigmaNew,Alpsup,yapp,pos,nbsv,nbclass,option) ;
