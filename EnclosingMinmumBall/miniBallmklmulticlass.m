function [radius,Sigma,Alpsup,w0,pos,nbsv,SigmaH,obj] = miniBallmklmulticlass(K,yapp,C,nbclass,option,verbose)
...
switch option.algo
    case 'oneagainstall'
        [radius,optimalBeta,xsup,Alpsup,w0,nbsv,pos,obj] = miniBallmulticlassoneagainstall([],yapp,C,nbclass,lambdareg,K,Sigma,verbosesvm);
        [grad] =gradMiniBalloneagainstall(K,pos,Alpsup,nbsv,radius,optimalBeta,Sigma);
    case 'oneagainstone'
...
while loop 
    ...
    %---------------------------------------------
    t = cputime ;
    [radius,optimalBeta,Sigma,Alpsup,w0,pos,nbsv,obj] = miniBallmulticlassupdate(K,Sigma,C,pos,Alpsup,w0,yapp,nbclass,nbsv,grad,obj,radius,optimalBeta,option);
