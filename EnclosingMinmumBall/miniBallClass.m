function [radius,optimalBeta,xsup,w,d,pos,alpha,obj]=miniBallClass(x,y,C,lambda,Kt, Sigma,verbose,alphainit)

K=sumKbeta(Kt,Sigma);
n=size(K,1);

%compute the radius of enclosing minimum ball
[radius, optimalBeta]= minBallRadius(K,lambda,verbose);		
