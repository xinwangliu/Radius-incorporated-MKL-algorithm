function [Sigma,Alpsup,w0,pos,history,obj,status] = l2SVMradiusMarginBound(K,yapp,C,option,verbose)
%% Author: Xinwang Liu
% Inputs
%
...
%compute gradient
[grad] = l2SVMradiusMarginBoundGrad(K,pos,Alpsup,margin,radius,optimalBeta);
...
while loop & nloopmax >0 ;
    ...
    %-----------------------------------------
    t = cputime ;
    [radius,optimalBeta, margin,Sigma,Alpsup,w0,pos,obj] = l2SVMradiusMarginBoundUpdate(K,Sigma,pos,Alpsup,w0,C,yapp,grad,obj,radius,optimalBeta, margin, option) ;
