function [radius,optimalBeta, margin,Sigma,Alpsup,w0,pos,CostNew] = l2SVMradiusMarginBoundUpdate(K,Sigma,pos,Alpsup,w0,C,yapp,GradNew,CostNew,radiusNew,optimalBetaNew, marginNew, option)
...
while costmax<costmin;
    ...
    [costmax,radiusaux, optimalBetaaux, Alpsupaux,w0aux,posaux, marginaux] = costl2SVMradiusMarginBoundclass(K,stepmax,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
...
while (stepmax-stepmin)>option.goldensearch_deltmax*(abs(deltmax))  & stepmax > eps;
    ...
    [costmedr,radiusr, optimalBetar,Alpsupr,w0r,posr, marginr] = costl2SVMradiusMarginBoundclass(K,stepmedr,desc,SigmaNew,pos,Alpsup,C,yapp,option) ;
    [costmedl,radiusl, optimalBetal,Alpsupl,w0l,posl, marginl] = costl2SVMradiusMarginBoundclass(K,stepmedl,desc,SigmaNew,posr,Alpsupr,C,yapp,option) ;
